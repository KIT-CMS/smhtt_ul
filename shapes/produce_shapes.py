...
WITH_SPLIT_SIGNAL_PRUNED = False
...
def collect_config(
    ...
    logger.info(f"Configuration written to {_path}")
...
def main(args):
    ...
    if args.collect_config_only:
        ...
        logger.warning("Forcing process exit after config collection to avoid known ROOT/xrd shutdown hang.")
        logging.shutdown()
        os._exit(0)
        return
