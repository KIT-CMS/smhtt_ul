...
def get_control_units(
    ...
    # - channel selection
    # - MC weights for DY samples
    # - generator-level Z -> ell ell selection for events with jet -> tau_h fakes
    add_control_process(
        control_units,
        name="zj",
        dataset=datasets["DY"],
    ...
    # - channel selection
    # - MC weights for ST samples
    # - generator-level selection for genuine tau pairs
    add_control_process(
        control_units,
        name="vvt",
        dataset=datasets["VV"],
    ...
    # - channel selection
    # - MC weights for ST samples
    # - generator-level selection for l -> tau_h fakes
    add_control_process(
        control_units,
        name="vvl",
        dataset=datasets["VV"],
