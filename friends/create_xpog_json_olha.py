...
class TauID(Correction):
    ...
    def generate_dm_sfs(self, wp, wp_vsele):
                                ...
                                "value": {
                                    ...
                                    "content": [
                                        ...
                                        },
                                        {
                                            "key": "up",
                                            "value": self.get_tauID_sf(
                                                f"DM_{dm[1]}", "up", isDM=True
                                            ),
                                        },
                                        {
                                            "key": "down",
                                            "value": self.get_tauID_sf(
                                                f"DM_{dm[1]}", "down", isDM=True
                                            ),
                                        },
                                    ],
                                },
    ...
    def generate_dm_scheme(self, wp, wp_vsele):
        self.parse_config()
        self.setup_dm_scheme()
        self.correctionset["data"] = self.generate_dm_sfs(wp, wp_vsele)
        output_corr = schema.Correction.parse_obj(self.correctionset)
        self.correction = output_corr
        # print(JSONEncoder.dumps(self.correction))
...
# parser.add_argument("--output", type=str, default="", help="output") # Remnant, usgage???
...
correction_dm.generate_dm_scheme(args.wp, args.wp_vsele)
