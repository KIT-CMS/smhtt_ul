...
class TauID(Correction):
    ...
    def parse_config(self):
        ...
        self.dm_categories = ["DM0", "DM1", "DM10_11"]
        ...
        dm_binning = ["DM0", "DM1", "DM10", "DM11", "DM10_11"] # ToDo: adjust for DM_Pt !!!
        # self.wps = ["Loose", "Medium", "Tight", "VTight"]
        # self.vsele_wps = ["VVLoose", "VLoose", "Loose", "Medium", "Tight"]
        ...
        self.correctionset = {
            ...
            "inputs": [
                ...
                },
                {
                    "name": "wp",
                    "type": "string",
                    "description": "DeepTau2017v2p1VSjet working point: Loose-VTight ",
                },
                {
                    "name": "vsele_wp",
                    "type": "string",
...
# ToDo: adjust for DM_Pt !!!
    def generate_dm_sfs(self, wp, wp_vsele,dm_bins=[[0, 0],[1, 1],[10, "10_11"],]):
                                ...
                                "value": {
                                    ...
                                    "content": [
                                        ...
                                        },
                                        {
                                            "key": "up",
                                            "value": self.get_tauID_sf(
                                                f"DM{dm[1]}", "up", isDM=True
                                            ),
                                        },
                                        {
                                            "key": "down",
                                            "value": self.get_tauID_sf(
                                                f"DM{dm[1]}", "down", isDM=True
                                            ),
                                        },
                                    ],
                                },
                            }
                            for dm in dm_bins  # for DM 10 and 11 put DM_10_11 !
                        ],
                    },
                }
            ],
        ...
        #                         {
        #                             "key": "nom",
        #                             "value": self.get_tauID_sf("DM_0", "nom", wp, wp_VSe, isDM=True,),
        #                         },
        #                         {
        #                             "key": "up",
        #                             "value": self.get_tauID_sf("DM_0", "up", wp, wp_VSe, isDM=True),
        #                         },
        #                         {
        #                             "key": "down",
        #                             "value": self.get_tauID_sf("DM_0", "down", wp, wp_VSe, isDM=True),
        #                         },
        #                     ],
        #                 },
        #             },
        ...
        #                         {
        #                             "key": "nom",
        #                             "value": self.get_tauID_sf("DM_1", "nom", isDM=True),
        #                         },
        #                         {
        #                             "key": "up",
        #                             "value": self.get_tauID_sf("DM_1", "up", isDM=True),
        #                         },
        #                         {
        #                             "key": "down",
        #                             "value": self.get_tauID_sf("DM_1", "down", isDM=True),
        #                         },
        #                     ],
        #                 },
        #             },
        ...
        #                         {
        #                             "key": "nom",
        #                             "value": self.get_tauID_sf("DM_10_11", "nom", isDM=True),
        #                         },
        #                         {
        #                             "key": "up",
        #                             "value": self.get_tauID_sf("DM_10_11", "up", isDM=True),
        #                         },
        #                         {
        #                             "key": "down",
        #                             "value": self.get_tauID_sf("DM_10_11", "down", isDM=True),
        #                         },
        #                     ],
        #                 },
        #             },
        ...
        #         ],
        #     }
        #     data["content"].append({"key": wp, "value": sfs}) # Missing wp_VSe!
        # -------
        return schema.Category.parse_obj(data)
# ToDo: adjust for DM_Pt !!!
    def generate_pt_sfs(self, wp, wp_vsele):
        data = {"nodetype": "category", "input": "wp", "content": []}
        sfs = {
            "nodetype": "category",
            "input": "vsele_wp",
                        ...
                        "content": [
                            {
                                ...
                                "content": [
                                    ...
                                    {
                                        "key": "up",
                                        "value": self.get_tauID_sf(pt, "up", isPt=True),
                                    },
                                    {
                                        "key": "down",
                                        "value": self.get_tauID_sf(
        ...
        return schema.Category.parse_obj(data)
# ToDo: adjust for DM_Pt? !!!
    def get_tauID_sf(self, variable, variation, isPt=False, isDM=False):
        if isPt:
    ...
    def generate_pt_scheme(self, wp, wp_vsele):
        self.parse_config()
        self.setup_pt_scheme()
        self.correctionset["data"] = self.generate_pt_sfs(wp, wp_vsele)
...
# ToDo: adjust for DM_Pt !!!
    def generate_dm_scheme(self, wp, wp_vsele,dm_bins=[[0, 0],[1, 1],[10, "10_11"],]):
        self.parse_config()
        self.setup_dm_scheme()
        self.correctionset["data"] = self.generate_dm_sfs(wp, wp_vsele, dm_bins=dm_bins)
        output_corr = schema.Correction.parse_obj(self.correctionset)
        self.correction = output_corr
        # print(JSONEncoder.dumps(self.correction))
...
parser.add_argument("--dm_bins", type=str, default="DM0,DM1,DM10_11", help="DM bins, no spaces allowed!")
...
# dm_fitfile = args.input_dm + "higgsCombine.comb_dm_fit.MultiDimFit.mH120.root"

dm_fitfile = args.input_dm #+ "cmb/higgsCombine.multidim_dm_fit.MultiDimFit.mH125.root"
# dm_fitfile = args.input_dm + "cmb/higgsCombine.comb_dm_1_corr_v2.MultiDimFit.mH120.root"
...
dm_binnames = args.dm_bins.split(",")
...
#     era=args.era,outdir="/",
#     wps=args.wp,
#     wps_VSe=args.wp_vsele
# )
# correction_pt.generate_pt_scheme(args.wp, args.wp_vsele)
...
# ToDo: adjust for DM_Pt !!!
dm_map = {"DM0": [0,0], "DM1": [1,1], "DM10_11": [10,'10_11'], "DM10":[10,10], "DM11":[11,11]}
correction_dm.generate_dm_scheme(args.wp, args.wp_vsele, dm_bins=[dm_map[i] for i in dm_binnames])
