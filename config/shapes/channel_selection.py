...
def channel_selection(channel, era, special=None, vs_jet_wp="Tight", vs_ele_wp="VVLoose", vs_mu_wp="Tight", selection_option="CR", **kwargs):
    ...
    if special is None:
        if "mt" in channel:
            ...
            if era == "2016preVFP" or era == "2016postVFP":
                cuts["trg_selection"] = """(
                    ...
                    (
                        (trg_single_mu22 > 0.5) ||
                        (trg_single_mu22_tk > 0.5) ||
                        (trg_single_mu22_eta2p1 > 0.5) ||
                        (trg_single_mu22_tk_eta2p1 > 0.5)
                    )
                )"""
        ...
        if "em" in channel:
            ...
            if era == "2018":
                cuts["trg_selection"] = """(
                    (
                        (trg_cross_mu23ele12 > 0.5) &&
                        (pt_1 > 15) &&
                        (pt_2 > 24)
                    ) ||
                    (
                        (trg_cross_mu8ele23 > 0.5) &&
                        (pt_1 > 24) &&
                        (pt_2 > 15)
                    )
                )"""
