...
common_binning = HistogramBuildingDict(
    {
        ...
        "pzetamissvis": np.arange(-350, 250, 5),
        "pzetamissvis_pf": np.arange(-350, 250, 5),
        "pzetamissvis_bb": np.arange(-350, 250, 5),
        "pzetamissvis_bbtautau": np.arange(-350, 250, 5),
        ...
        "pt_2": np.concatenate(([0], np.arange(20, 140, 5))), #[0, 30, 35, 40, 45, 50, 60, 70, 90, 110, 140],
        ...
        "jeta_1": np.linspace(-3, 3, 30),
        "jeta_2": np.linspace(-3, 3, 30),
        "jphi_1": np.linspace(-np.pi, np.pi, 30),
        "jphi_2": np.linspace(-np.pi, np.pi, 30),
        "jdeta": np.arange(0, 6, 0.2),
        "n_jets": np.arange(-0.5, 7.5, 1),
        "njets": np.arange(-0.5, 7.5, 1),
        "n_bjets": np.arange(-0.5, 7.5, 1),
        ...
        "sum_deltaR_tt_bb": Histogram(
            "sum_deltaR_tt_bb",
            """
                bpair_deltaR + deltaR_ditaupair
            """,
            np.arange(0, 10.4, 0.2),
        ),
        "deltaPhi_met_dilepton": np.linspace(-np.pi, np.pi, 50),
        "deltaPhi_met_dilepton_friend": np.linspace(-np.pi, np.pi, 50),
    }
)
common_binning_tt = HistogramBuildingDict(
    {
        "mass_2": np.arange(0, 2.1, 0.1),
        "mass_1": np.arange(0, 2.1, 0.1),
        "genbosonpt": np.arange(0, 150, 10),
        ...
        "mt_tot_puppi": np.arange(0, 400, 8),
        "pt_1": np.concatenate(([0], np.arange(20, 140, 5))),
        "pt_2": np.concatenate(([0], np.arange(20, 140, 5))),
        "eta_1": np.linspace(-2.5, 2.5, 50),
        "eta_2": np.linspace(-2.5, 2.5, 50),
        "jpt_1": np.concatenate(([0], np.arange(20, 250, 5))),
        "jpt_2": np.concatenate(([0], np.arange(20, 250, 5))),
...
control_binning = {ch: common_binning if ch != "tt" else common_binning_tt for ch in ["et", "mt", "tt", "em", "ee", "mm"]}
