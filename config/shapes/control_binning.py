...
common_binning = {
    ...
    "m_vis": Histogram("m_vis", "m_vis", np.arange(0, 305, 20)),
    ...
    # kinfit
    "kinfit_mX": Histogram("kinfit_mX", "kinfit_mX", [0,220,260,290,310,340,380,425,475,525,575,625,675,725,775,825,875,925,975,1050]),
    "kinfit_mY": Histogram("kinfit_mY", "kinfit_mY", [0,45,55,65,75,85,92.5,97.5,112.5,137.5,200,275,350,450,550,650,750,850]), 
    ...
    "kinfit_mX_YToBB": Histogram("kinfit_mX_YToBB", "kinfit_mX_YToBB", [0,220,260,290,310,340,380,425,475,525,575,625,675,725,775,825,875,925,975,1050,1150,1250,1350,1450,1550,1650,1750,1850,1950,2100,2300,2450,2550,2700,2900,3250,3750,4250]),
    "kinfit_mY_YToBB": Histogram("kinfit_mY_YToBB", "kinfit_mY_YToBB", [0,45,55,65,75,85,92.5,97.5,112.5,137.5,200,275,350,450,550,650,750,850,950,1050,1150,1250,1350,1500,1700,1900,2100,2300,2450,2550,2700,2900,3250,3750]),
    ...
    "kinfit_mX_YToTauTau": Histogram("kinfit_mX_YToTauTau", "kinfit_mX_YToTauTau", [0,220,260,290,310,340,380,425,475,525,575,625,675,725,775,825,875,925,975,1050,1150,1250,1350,1450,1550,1650,1750,1850,1950,2100,2300,2450,2550,2700,2900,3250,3750,4250]),
    "kinfit_mY_YToTauTau": Histogram("kinfit_mY_YToTauTau", "kinfit_mY_YToTauTau", [0,45,55,65,75,85,92.5,97.5,112.5,137.5,200,275,350,450,550,650,750,850,950,1050,1150,1250,1350,1500,1700,1900,2100,2300,2450,2550,2700,2900,3250,3750]),
    ...
    "kinfit_mX_boosted": Histogram("kinfit_mX_boosted", "kinfit_mX_boosted", [0,220,260,290,310,340,380,425,475,525,575,625,675,725,775,825,875,925,975,1050]),
    "kinfit_mY_boosted": Histogram("kinfit_mY_boosted", "kinfit_mY_boosted",  [0,45,55,65,75,85,92.5,97.5,112.5,137.5,200,275,350,450,550,650,750,850]), 
    ...
    "kinfit_mX_YToBB_boosted": Histogram("kinfit_mX_YToBB_boosted", "kinfit_mX_YToBB_boosted", [0,220,260,290,310,340,380,425,475,525,575,625,675,725,775,825,875,925,975,1050,1150,1250,1350,1450,1550,1650,1750,1850,1950,2100,2300,2450,2550,2700,2900,3250,3750,4250]),
    "kinfit_mY_YToBB_boosted": Histogram("kinfit_mY_YToBB_boosted", "kinfit_mY_YToBB_boosted", [0,45,55,65,75,85,92.5,97.5,112.5,137.5,200,275,350,450,550,650,750,850,950,1050,1150,1250,1350,1500,1700,1900,2100,2300,2450,2550,2700,2900,3250,3750]),
    "kinfit_chi2_YToBB_boosted": Histogram("kinfit_chi2_YToBB_boosted", "kinfit_chi2_YToBB_boosted", np.arange(0, 50, 1)),
    "kinfit_convergence_YToBB_boosted": Histogram("kinfit_convergence_YToBB_boosted", "kinfit_convergence_YToBB_boosted", [-4.5,-3.5,-2.5,-1.5,-0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5]),
    "kinfit_mX_YToTauTau_boosted": Histogram("kinfit_mX_YToTauTau_boosted", "kinfit_mX_YToTauTau_boosted", [0,220,260,290,310,340,380,425,475,525,575,625,675,725,775,825,875,925,975,1050,1150,1250,1350,1450,1550,1650,1750,1850,1950,2100,2300,2450,2550,2700,2900,3250,3750,4250]),
    "kinfit_mY_YToTauTau_boosted": Histogram("kinfit_mY_YToTauTau_boosted", "kinfit_mY_YToTauTau_boosted", [0,45,55,65,75,85,92.5,97.5,112.5,137.5,200,275,350,450,550,650,750,850,950,1050,1150,1250,1350,1500,1700,1900,2100,2300,2450,2550,2700,2900,3250,3750]),
    "kinfit_chi2_YToTauTau_boosted": Histogram("kinfit_chi2_YToTauTau_boosted", "kinfit_chi2_YToTauTau_boosted", np.arange(0, 50, 1)),
    "kinfit_convergence_YToTauTau_boosted": Histogram("kinfit_convergence_YToTauTau_boosted", "kinfit_convergence_YToTauTau_boosted", [-4.5,-3.5,-2.5,-1.5,-0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5]),
    # fastmtt variables
    "m_fastmtt": Histogram("m_fastmtt", "m_fastmtt", np.arange(0, 405, 20)),
    "pt_fastmtt": Histogram("pt_fastmtt", "pt_fastmtt", np.arange(0, 305, 10)),
    "eta_fastmtt": Histogram("eta_fastmtt", "eta_fastmtt", np.linspace(-2.5, 2.5, 25)),
    "phi_fastmtt": Histogram("phi_fastmtt", "phi_fastmtt", np.linspace(-3.14, 3.14, 25)),
    ...
    "mass_tautaubb": Histogram("mass_tautaubb", "mass_tautaubb", np.arange(100, 905, 30)),
    # b jets
    ...
    "bpair_eta_1": Histogram("bpair_eta_1", "bpair_eta_1", np.linspace(-3, 3, 20)),
    "bpair_eta_2": Histogram("bpair_eta_2", "bpair_eta_2", np.linspace(-3, 3, 20)),
    "bpair_phi_1": Histogram("bpair_phi_1", "bpair_phi_1", np.linspace(-3.14, 3.14, 20)),
    "bpair_phi_2": Histogram("bpair_phi_2", "bpair_phi_2", np.linspace(-3.14, 3.14, 20)),
    ...
    "bpair_deltaR": Histogram("bpair_deltaR", "bpair_deltaR", np.arange(0, 5, 0.2)),
    ...
    "fj_Xbb_pt": Histogram("fj_Xbb_pt", "fj_Xbb_pt", [200,250,400,500,600,700]),
    "fj_Xbb_eta": Histogram("fj_Xbb_eta", "fj_Xbb_eta", np.linspace(-2.6, 2.6, 5)),
    "fj_Xbb_phi": Histogram("fj_Xbb_phi", "fj_Xbb_phi", np.linspace(-3.14, 3.14, 5)),
    "fj_Xbb_mass": Histogram("fj_Xbb_mass", "fj_Xbb_mass", [0,30,80,120,180,250]),
    "fj_Xbb_nsubjettiness_2over1": Histogram("fj_Xbb_nsubjettiness_2over1", "fj_Xbb_nsubjettiness_2over1", np.linspace(0, 1, 6)),
    "fj_Xbb_nsubjettiness_3over2": Histogram("fj_Xbb_nsubjettiness_3over2", "fj_Xbb_nsubjettiness_3over2", np.linspace(0, 1, 6)),
    "fj_Xbb_particleNet_XbbvsQCD": Histogram("fj_Xbb_particleNet_XbbvsQCD", "fj_Xbb_particleNet_XbbvsQCD", np.linspace(0.5, 1, 6)),
    "fj_Xbb_msoftdrop": Histogram("fj_Xbb_msoftdrop", "fj_Xbb_msoftdrop", [0,30,80,120,180,250]),
    ...
    "boosted_pt_1": Histogram("boosted_pt_1", "boosted_pt_1", np.arange(20, 310, 20)),
    ...
    "boosted_mass_1": Histogram("boosted_mass_1", "boosted_mass_1", np.arange(0, 2.2, 0.1)),
    ...
    "boosted_tau_decaymode_1": Histogram(
    ...
    "boosted_deltaR_ditaupair": Histogram("boosted_deltaR_ditaupair", "boosted_deltaR_ditaupair", np.arange(0, 1.0, 0.1)),
    ...
    "pfmet_boosted": Histogram("pfmet_boosted", "pfmet_boosted", np.arange(0, 250, 10)),
    ...
    "boosted_mass_tautaubb": Histogram("boosted_mass_tautaubb", "boosted_mass_tautaubb", np.arange(100, 910, 30)),
    "fj_Xbb_pt_boosted": Histogram("fj_Xbb_pt_boosted", "fj_Xbb_pt_boosted", [200,250,400,500,600,700]),
    "fj_Xbb_eta_boosted": Histogram("fj_Xbb_eta_boosted", "fj_Xbb_eta_boosted", np.linspace(-2.6, 2.6, 5)),
    "fj_Xbb_phi_boosted": Histogram("fj_Xbb_phi_boosted", "fj_Xbb_phi_boosted", np.linspace(-3.14, 3.14, 5)),
    "fj_Xbb_mass_boosted": Histogram("fj_Xbb_mass_boosted", "fj_Xbb_mass_boosted", [0,30,80,120,180,250]),
    "fj_Xbb_nsubjettiness_2over1_boosted": Histogram("fj_Xbb_nsubjettiness_2over1_boosted", "fj_Xbb_nsubjettiness_2over1_boosted", np.linspace(0, 1, 6)),
    "fj_Xbb_nsubjettiness_3over2_boosted": Histogram("fj_Xbb_nsubjettiness_3over2_boosted", "fj_Xbb_nsubjettiness_3over2_boosted", np.linspace(0, 1, 6)),
    "fj_Xbb_particleNet_XbbvsQCD_boosted": Histogram("fj_Xbb_particleNet_XbbvsQCD_boosted", "fj_Xbb_particleNet_XbbvsQCD_boosted", np.linspace(0.5, 1, 6)),
    "fj_Xbb_msoftdrop_boosted": Histogram("fj_Xbb_msoftdrop_boosted", "fj_Xbb_msoftdrop_boosted", [0,30,80,120,180,250]),
    "fj_leading_pt": Histogram("fj_leading_pt", "fj_leading_pt", np.arange(160, 750, 40)),
    "fj_leading_msoftdrop": Histogram("fj_leading_msoftdrop", "fj_leading_msoftdrop", np.arange(0, 280, 20)),
    ...
    "deltaR_bjet1_fatjet": Histogram("deltaR_bjet1_fatjet", "ROOT::VecOps::DeltaR(bpair_eta_1, fj_Xbb_eta, bpair_phi_1, fj_Xbb_phi)*1", np.arange(0, 4.5, 0.1)),
    "deltaR_bjet2_fatjet": Histogram("deltaR_bjet2_fatjet", "ROOT::VecOps::DeltaR(bpair_eta_2, fj_Xbb_eta, bpair_phi_2, fj_Xbb_phi)*1", np.arange(0, 4.5, 0.1)),
    ...
    "deltaR_tau1_bjet1": Histogram("deltaR_tau1_bjet1", "ROOT::VecOps::DeltaR(eta_1, bpair_eta_1, phi_1, bpair_phi_1)*1", np.arange(0, 4.5, 0.1)),
    "deltaR_tau2_bjet1": Histogram("deltaR_tau2_bjet1", "ROOT::VecOps::DeltaR(eta_2, bpair_eta_1, phi_2, bpair_phi_1)*1", np.arange(0, 4.5, 0.1)),
    "deltaR_tau1_bjet2": Histogram("deltaR_tau1_bjet2", "ROOT::VecOps::DeltaR(eta_1, bpair_eta_2, phi_1, bpair_phi_2)*1", np.arange(0, 4.5, 0.1)),
    "deltaR_tau2_bjet2": Histogram("deltaR_tau2_bjet2", "ROOT::VecOps::DeltaR(eta_2, bpair_eta_2, phi_2, bpair_phi_2)*1", np.arange(0, 4.5, 0.1)),
    ...
    "deltaPhi_met_bjet1": Histogram("deltaPhi_met_bjet1", "ROOT::VecOps::DeltaPhi(metphi, bpair_phi_1)*1", np.arange(-3.5, 3.5, 0.2)),
    "deltaPhi_met_bjet2": Histogram("deltaPhi_met_bjet2", "ROOT::VecOps::DeltaPhi(metphi, bpair_phi_2)*1", np.arange(-3.5, 3.5, 0.2)),
    ...
    "deltaR_b1_t1": Histogram("deltaR_b1_t1", "ROOT::VecOps::DeltaR(bpair_eta_1_boosted, boosted_eta_1, bpair_phi_1_boosted, boosted_phi_1)*1", np.arange(0, 4.5, 0.4)),
    "deltaR_b2_t2": Histogram("deltaR_b2_t2", "ROOT::VecOps::DeltaR(bpair_eta_2_boosted, boosted_eta_2, bpair_phi_2_boosted, boosted_phi_2)*1", np.arange(0, 4.5, 0.4)),
    "deltaR_b2_t1": Histogram("deltaR_b2_t1", "ROOT::VecOps::DeltaR(bpair_eta_2_boosted, boosted_eta_1, bpair_phi_2_boosted, boosted_phi_1)*1", np.arange(0, 4.5, 0.4)),
    "deltaR_b1_t2": Histogram("deltaR_b1_t2", "ROOT::VecOps::DeltaR(bpair_eta_1_boosted, boosted_eta_2, bpair_phi_1_boosted, boosted_phi_2)*1", np.arange(0, 4.5, 0.4)),
    "deltaR_b1_fj": Histogram("deltaR_b1_fj", "ROOT::VecOps::DeltaR(bpair_eta_1_boosted, fj_Xbb_eta_boosted, bpair_phi_1_boosted, fj_Xbb_phi)*1", np.arange(0, 4.5, 0.4)),
    "deltaR_b2_fj": Histogram("deltaR_b2_fj", "ROOT::VecOps::DeltaR(bpair_eta_2_boosted, fj_Xbb_eta_boosted, bpair_phi_2_boosted, fj_Xbb_phi)*1", np.arange(0, 4.5, 0.4)),
    "deltaR_t1_fj": Histogram("deltaR_t1_fj", "ROOT::VecOps::DeltaR(boosted_eta_1, fj_Xbb_eta_boosted, boosted_phi_1, fj_Xbb_phi_boosted)*1", np.arange(0, 4.5, 0.4)),
    "deltaR_t2_fj": Histogram("deltaR_t2_fj", "ROOT::VecOps::DeltaR(boosted_eta_2, fj_Xbb_eta_boosted, boosted_phi_2, fj_Xbb_phi_boosted)*1", np.arange(0, 4.5, 0.4)),
    "deltaPhi_met_t2": Histogram("deltaPhi_met_t2", "ROOT::VecOps::DeltaPhi(metphi_boosted, boosted_phi_2)*1", np.arange(-3.5, 3.5, 0.4)),
    "deltaPhi_met_fj": Histogram("deltaPhi_met_fj", "ROOT::VecOps::DeltaPhi(metphi_boosted, fj_Xbb_phi_boosted)*1", np.arange(-3.5, 3.5, 0.4)),
    "deltaPhi_met_t1": Histogram("deltaPhi_met_t1", "ROOT::VecOps::DeltaPhi(metphi_boosted, boosted_phi_1)*1", np.arange(-3.5, 3.5, 0.4)),
    "deltaPhi_met_b1": Histogram("deltaPhi_met_b1", "ROOT::VecOps::DeltaPhi(metphi_boosted, bpair_phi_1_boosted)*1", np.arange(-3.5, 3.5, 0.4)),
    "deltaPhi_met_b2": Histogram("deltaPhi_met_b2", "ROOT::VecOps::DeltaPhi(metphi_boosted, bpair_phi_2_boosted)*1", np.arange(-3.5, 3.5, 0.4)),
