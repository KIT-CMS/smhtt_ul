...
common_binning = {
    ...
    "m_vis": Histogram("m_vis", "m_vis", np.linspace(30, 150, 24)),
    ...
    "pt_1": Histogram("pt_1", "pt_1", np.append(np.array([0]) ,np.arange(20, 150, 5))),
    "pt_2": Histogram("pt_2", "pt_2",np.linspace(20, 140, 24)),
    # "pt_2": Histogram("pt_2", "pt_2", np.append(np.array([0]) ,np.arange(20, 150, 5))),
...
common_binning_simple = {
    ...
    # "m_vis": "m_vis", "m_vis", np.arange(0, 260, 10)), # or use "m_vis" : "m_vis", "m_vis", [10, 260]), for one bin only
    "m_vis": np.linspace(30, 150, 25),
    ...
    "ME_phi": np.linspace(-3.14, 3.14, 50),
    "ME_phi1": np.linspace(-3.14, 3.14, 50),
    "pfmetphi": np.linspace(-3.14, 3.14, 50),
    "metphi": np.linspace(-3.14, 3.14, 50),
    "mt_tot": np.arange(0, 400, 8),
    "mt_tot_puppi": np.arange(0, 400, 8),
    "pt_1": np.append(np.array([0]) ,np.arange(20, 150, 5)),
    "pt_2": np.linspace(20, 140, 11),
    # "pt_2": np.append(np.array([0]) ,np.arange(20, 150, 5))),
    "eta_1": np.linspace(-2.5, 2.5, 50),
    "eta_2": np.linspace(-2.5, 2.5, 50),
    "jpt_1": np.append(np.array([0]) ,np.arange(20, 160, 5)),
    "jpt_2": np.append(np.array([0]) ,np.arange(20, 160, 5)),
    "jeta_1": np.linspace(-5, 5, 50),
    "jeta_2": np.linspace(-5, 5, 50),
    "jphi_1": np.linspace(-3.14, 3.14, 50),
    "jphi_2": np.linspace(-3.14, 3.14, 50),
    "jdeta": np.arange(0, 6, 0.2),
    "njets": [-0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5],
    "nbtag": [-0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5],
    "tau_decaymode_1":[-0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5, 8.5, 9.5, 10.5, 11.5],
    "tau_decaymode_2":[-0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5, 8.5, 9.5, 10.5, 11.5],
    ...
    "pfmet": np.append(np.arange(0, 160, 5) , np.array([200,400])),
    ...
    "phi_fastmtt": np.linspace(-3.14, 3.14, 50),
    "npartons": [-0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5],
    "phi_1": np.linspace(-2.5, 2.5, 50),
    "phi_2": np.linspace(-2.5, 2.5, 50),
    "q_1": [-3, 3],  # for overall yield
}

control_binning_simple = {}
for channel in ["et", "mt", "tt", "em", "ee", "mm"]:
    control_binning_simple[channel] = common_binning_simple