...
common_binning = HistogramBuildingDict(
    {
        ...
        "deltaEta_ditaupair": np.linspace(-9, 9, 20),
        ...
        "deltaEta_jj": np.arange(-9, 9, 0.2),
        "deltaEta_1j1": np.arange(-9, 9, 0.2),
        "deltaEta_1j2": np.arange(-9, 9, 0.2),
        "deltaEta_2j1": np.arange(-9, 9, 0.2),
        "deltaEta_2j2": np.arange(-9, 9, 0.2),
        "deltaEta_12j1": np.arange(-9, 9, 0.2),
        "deltaEta_12j2": np.arange(-9, 9, 0.2),
        "deltaEta_12jj": np.arange(-9, 9, 0.2),
        "deltaPhi_jj": np.arange(-2 * np.pi, 2 * np.pi, 0.2),
        "deltaPhi_1j1": np.arange(-2 * np.pi, 2 * np.pi, 0.2),
        "deltaPhi_1j2": np.arange(-2 * np.pi, 2 * np.pi, 0.2),
        "deltaPhi_2j1": np.arange(-2 * np.pi, 2 * np.pi, 0.2),
        "deltaPhi_2j2": np.arange(-2 * np.pi, 2 * np.pi, 0.2),
        "deltaPhi_12j1": np.arange(-2 * np.pi, 2 * np.pi, 0.2),
        "deltaPhi_12j2": np.arange(-2 * np.pi, 2 * np.pi, 0.2),
        "deltaPhi_12jj": np.arange(-2 * np.pi, 2 * np.pi, 0.2),
