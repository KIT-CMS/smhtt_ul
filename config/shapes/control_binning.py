...
common_binning = HistogramBuildingDict(
    {
        ...
        "deltaEta_jj": np.arange(-10, 10, 0.2),
        "deltaEta_1j1": np.arange(-10, 10, 0.2),
        "deltaEta_1j2": np.arange(-10, 10, 0.2),
        "deltaEta_2j1": np.arange(-10, 10, 0.2),
        "deltaEta_2j2": np.arange(-10, 10, 0.2),
        "deltaEta_12j1": np.arange(-10, 10, 0.2),
        "deltaEta_12j2": np.arange(-10, 10, 0.2),
        "deltaEta_12jj": np.arange(-10, 10, 0.2),
